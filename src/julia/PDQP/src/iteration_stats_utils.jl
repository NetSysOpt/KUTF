...
function compute_dual_stats!(
    ...
    rcc = reduced_costs_dual_objective_contribution(problem, buffer_kkt)
    # @info "base dual obj: $(base_dual_objective)"
    # @info "RCC obj: $(rcc)"
    buffer_kkt.dual_stats.dual_objective = base_dual_objective + rcc
end
...
function compute_convergence_information(
    ...
    # @info "primal obj: $(convergence_info.primal_objective)"
