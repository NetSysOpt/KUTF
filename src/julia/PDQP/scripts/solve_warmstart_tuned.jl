...
function solve_instance_and_output(
    ...
    function inner_solve()
        ...
        # output, output_scaled = PDQP.optimize_warmstart(parameters, qp, primal, dual, "", pw, ss, iteration)
        # output, output_scaled = PDQP.optimize_warmstart(parameters, qp, primal, dual, pw, ss)
        output, output_scaled = PDQP.optimize_pd(parameters, qp, primal, dual,pw,ss)
